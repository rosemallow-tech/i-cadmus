  ...
  <div class="container">
    <div class="page-hero-inner">
      ...
      <div class="page-hero-grid">
        ...
        <div class="hero-letter-box">A</div>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="cat-page-layout">
    <aside class="framework-side">
      ...
      <ul>
        ...
        <li><a href="adulteration.php" class="active"><span class="letter">A</span> Adulteration</a></li>
    ...
    <main class="cat-content">
      ...
      <div class="cat-body reveal">
        ...
        <div>
          <div class="cat-info-card">
            <h4>Red flags</h4>
            <ul>
              <li>Excessive moisture released during cooking — product "steams" rather than sears</li>
              <li>Unusually translucent, bright-white, or wet-looking scallop or prawn flesh</li>
              <li>Pack weight inconsistent with apparent product volume when thawed</li>
              <li>Unlisted additives or vague "moisture added" without quantification</li>
              <li>Allergen warnings absent for sulphite-treated product</li>
            </ul>
          </div>
          <div class="cat-info-card counter" style="margin-top:16px;">
            <h4>Counter-measures</h4>
            <ul>
              <li>Mandatory quantitative additive labelling — exact percentage by weight</li>
              <li>Cook-out weight disclosure (weight after cooking, not just raw weight)</li>
              <li>Allergen-specific sulphite warnings on all treated product</li>
              <li>Additive testing at border inspection and retail audit</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="sector-section reveal">
        ...
        <p class="sub">Adulteration can only be detected through testing — making procurement-level controls critical.</p>
        <div class="sector-grid">
          <div class="sector-card">
            <div class="sector-label">Consumers</div>
            <h5>What you can do</h5>
            <ul>
              <li>Look for "moisture added" disclosures and quantified percentage</li>
              <li>Prefer product with cook-out weight declared on pack</li>
              <li>If you have a sulphite allergy, scrutinise all prawn and shellfish labels</li>
            </ul>
          </div>
          <div class="sector-card">
            ...
            <h5>What you can do</h5>
            <ul>
              <li>Require supplier disclosure of all additives and retention percentages</li>
              <li>Request additive testing certificates for high-volume lines</li>
              <li>Mandate cook-out weight testing as part of supplier qualification</li>
            </ul>
          </div>
          <div class="sector-card">
            ...
            <h5>What you can do</h5>
            <ul>
              <li>Declare all additives on commercial invoices and product specifications</li>
              <li>Implement incoming product testing for phosphate retention and moisture content</li>
              <li>Refuse supply from processors who cannot quantify additive use</li>
            </ul>
          </div>
          <div class="sector-card">
            ...
            <h5>What you can do</h5>
            <ul>
              <li>Require quantitative declaration of all added moisture and phosphates on label</li>
              <li>Mandate allergen warnings for sulphite-treated product at all retail levels</li>
              <li>Include additive testing in seafood surveillance programs</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="related-section reveal">
        ...
        <div class="related-grid">
          ...
          <a href="misrepresentation.php" class="related-card">
            ...
            <p>Processing in certain jurisdictions enables adulteration practices that would be illegal in the country of sale.</p>
          </a>
          <a href="substitution.php" class="related-card">
            ...
            <p>Cheap substitute species are often treated with additives to mimic the texture and appearance of the premium species they replace.</p>
          </a>
        </div>
      </div>
