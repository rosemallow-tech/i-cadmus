...
<title>Counterfeit — Fake Labels | I-CADMUS Framework</title>
<meta name="description" content="Category C of the I-CADMUS framework: Counterfeit Fake Labels — forged certifications, fabricated origin claims, and manufactured brand identities." />
...
<style>
  :root {
    ...
    --line:#e5e8ec;--line-2:#d5dae0;--bg:#ffffff;--bg-soft:#f6f8fa;--bg-2:#eef2f6;
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  @media(max-width:1100px){
    ...
    .cat-page-layout{grid-template-columns:1fr;gap:32px;padding:48px 0;}.framework-side{position:static;}
    .framework-side ul{display:flex;gap:8px;overflow-x:auto;padding-bottom:8px;}
    .framework-side li a{border-left:none;border-bottom:2px solid transparent;padding:10px 12px;margin:0;white-space:nowrap;}
    .framework-side li a.active{border-bottom-color:var(--accent);border-left-color:transparent;}
    .cat-body{grid-template-columns:1fr;gap:24px;}.sector-grid{grid-template-columns:1fr;}
    .related-grid{grid-template-columns:1fr 1fr;}.cta-band-grid{grid-template-columns:1fr;}
    .footer-top{grid-template-columns:1fr 1fr;}.page-hero{padding:56px 0 72px;}
    .page-hero-grid{grid-template-columns:1fr;}.hero-letter-box{display:none;}
  }
  @media(max-width:640px){
    .related-grid{grid-template-columns:1fr;}.cat-nav{grid-template-columns:1fr;}
  ...
  <div class="container">
    <div class="page-hero-inner">
      <div class="breadcrumb">
        ...
        <span style="color:#fff;">Counterfeit — Fake Labels</span>
      </div>
      <div class="page-hero-grid">
        <div>
          <div class="cat-badge">Category 02 of 07 — I-CADMUS Framework</div>
          <h1><strong>Counterfeit</strong> — Fake Labels</h1>
          <p class="lede">Forged certifications, fabricated origin claims, and entirely manufactured brand identities.</p>
          <div style="display:flex;gap:12px;flex-wrap:wrap;">
            <a href="adulteration.php" class="btn btn-primary">Next: Adulteration <span class="arrow">→</span></a>
            <a href="framework.php" class="btn btn-outline" style="color:#fff;border-color:rgba(255,255,255,.4);">All seven categories</a>
          </div>
        </div>
        <div class="hero-letter-box">C</div>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="cat-page-layout">
    ...
    <main class="cat-content">
      <div class="cat-content-head reveal">
        <div class="cat-num">Category 02 · I-CADMUS Framework</div>
        <h2 class="cat-title">Counterfeit — Fake Labels</h2>
      ...
      <div class="cat-body reveal">
        <div>
          ...
          <p>The sophistication of counterfeit labelling has grown alongside the premium commanded by certified product. <strong>A forged MSC logo or a fake "Ora King" salmon brand</strong> can add 30–60% to the sale price of ordinary product. At the point of sale, neither the retailer nor the consumer has a practical means of verification — the label looks correct, the packaging is professional, and the certification code (if present) may be legitimately issued to a different lot entirely.</p>

          <div class="why-box">
            <h4>Why it persists</h4>
            <p>Certification marks add real price premiums, and verification at the point of sale is rare. A consumer almost never cross-checks a label against a certifier's public database. Enforcement depends on complaint-driven sampling, which means counterfeiters operate with low detection risk for extended periods.</p>
          </div>
        </div>
        <div>
          <div class="cat-info-card">
            <h4>Red flags</h4>
            <ul>
              <li>Certifications without verifiable lot numbers on the public database</li>
              <li>Brands with no traceable producer, vessel, or farm behind them</li>
              <li>"Geographic indication" labels in markets where the producer doesn't operate</li>
              <li>Inconsistent label printing, unusual fonts, or non-standard layouts</li>
              <li>QR codes that lead to generic pages rather than lot-specific records</li>
            </ul>
          </div>
          <div class="cat-info-card counter" style="margin-top:16px;">
            <h4>Counter-measures</h4>
            <ul>
              <li>QR-linked lot verification at point of sale — scannable by any shopper</li>
              <li>Tamper-evident certification holograms on primary packaging</li>
              <li>Public certifier databases with real-time lot search</li>
              <li>Retailer obligation to verify certification currency before listing</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="sector-section reveal">
        ...
        <p class="sub">Counterfeit labels exploit gaps in verification at every stage of the supply chain.</p>
        <div class="sector-grid">
          <div class="sector-card">
            <div class="sector-label">Consumers</div>
            <h5>What you can do</h5>
            <ul>
              <li>Scan QR codes on certified product — do the lot numbers match?</li>
              <li>Search the certifier's database directly (MSC, ASC, etc.) using the code on the label</li>
              <li>Report certification anomalies to the certifying body</li>
            </ul>
          </div>
          <div class="sector-card">
            ...
            <h5>What you can do</h5>
            <ul>
              <li>Verify certification currency with the issuing body before listing product</li>
              <li>Require chain-of-custody certificates, not just product certificates</li>
              <li>Conduct periodic label audits against certifier databases</li>
            </ul>
          </div>
          <div class="sector-card">
            ...
            <h5>What you can do</h5>
            <ul>
              <li>Only accept certified product with matching chain-of-custody documentation</li>
              <li>Implement lot-level traceability that links to the original certification</li>
              <li>Report suspected counterfeit certifications to the certifying body immediately</li>
            </ul>
          </div>
          <div class="sector-card">
            ...
            <h5>What you can do</h5>
            <ul>
              <li>Mandate that certification claims on labels be verifiable via public registry</li>
              <li>Prosecute false certification claims under consumer protection law</li>
              <li>Partner with certifying bodies for intelligence sharing on suspected fraud</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="related-section reveal">
        ...
        <div class="related-grid">
          <a href="illegal.php" class="related-card">
            ...
            <p>Forged certifications are often the mechanism used to launder IUU catch into certified supply chains.</p>
          </a>
          <a href="misrepresentation.php" class="related-card">
            ...
            <p>Counterfeit and misrepresentation often co-occur — fake labels typically carry false origin claims too.</p>
          </a>
          <a href="substitution.php" class="related-card">
            ...
            <p>Counterfeit premium-brand labels are frequently used to disguise cheaper substitute species.</p>
          </a>
        </div>
      </div>

      <div class="cat-nav reveal">
        <a href="illegal.php" class="cat-nav-card">
          <div class="cat-nav-label">← Previous</div>
          <div class="cat-nav-title">I — Illegal · IUU Laundering</div>
        </a>
        <a href="adulteration.php" class="cat-nav-card next">
