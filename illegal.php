...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .nav-primary>li>a:hover,.nav-primary>li>a.active-nav{color:var(--brand);border-bottom-color:var(--accent);}
  ...
  @media(max-width:1100px){
    ...
    .cat-page-layout{grid-template-columns:1fr;gap:32px;padding:48px 0;}
  ...
  <div class="container">
    <div class="page-hero-inner">
      ...
      <div class="page-hero-grid">
        ...
        <div class="hero-letter-box">I</div>
      </div>
    </div>
  </div>
</section>
...
<div class="container">
  <div class="cat-page-layout">
    ...
    <aside class="framework-side">
      ...
      <ul>
        <li><a href="illegal.php" class="active"><span class="letter">I</span> Illegal</a></li>
    ...
    <main class="cat-content">
      ...
      <div class="cat-body reveal">
        <div>
          <p>Illegal, Unreported and Unregulated (IUU) fishing accounts for a significant share of global seafood volume. The fraud isn't just the catch itself — it's the laundering pathway that transforms IUU product into apparently-legal commerce. Vessels transship at sea, paperwork is rewritten in flag-of-convenience ports, and the catch enters processing facilities indistinguishable from licit product.</p>
          <p>The label "IUU" covers three distinct behaviours that often overlap. <strong>Illegal fishing</strong> violates the laws of the flag state or the jurisdiction where the vessel operates. <strong>Unreported fishing</strong> is catch that is never declared to a fisheries authority. <strong>Unregulated fishing</strong> occurs in areas or for species outside effective management frameworks. All three feed the same laundering pipeline.</p>

          <div class="why-box">
            <h4>Why it persists</h4>
            <p>The price differential between legal and IUU product covers the cost of laundering many times over, and prosecutions are rare even where laws exist. Weak port-state controls, inconsistent flag-state enforcement, and opaque vessel ownership structures create a durable arbitrage that market forces alone cannot close.</p>
          </div>

          <div class="stat-callout" style="margin-top:24px;">
            <strong>~20%</strong>
            <span>Estimated share of global wild catch from IUU sources (UNODC / FAO estimates)</span>
          </div>
        </div>
        <div>
          <div class="cat-info-card">
            ...
            <ul>
              ...
              <li>Flag-of-convenience vessels in the supply chain with no ownership disclosure</li>
            </ul>
          </div>
          <div class="cat-info-card counter" style="margin-top:16px;">
            <h4>Counter-measures</h4>
            <ul>
              <li>Vessel-level catch documentation required at purchase</li>
              <li>Port state measures enforcement — inspection at landing</li>
              <li>Cross-border data sharing agreements (e.g. PSMA ratification)</li>
              <li>Blockchain or electronic catch documentation schemes</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="sector-section reveal">
        ...
        <p class="sub">IUU laundering touches every node in the supply chain. Responsibility is shared.</p>
        <div class="sector-grid">
          <div class="sector-card">
            <div class="sector-label">Consumers</div>
            <h5>What you can do</h5>
            <ul>
              <li>Ask retailers for vessel-of-origin information on wild-caught product</li>
              <li>Favour products with traceable certification (e.g. MSC with lot verification)</li>
              <li>Report suspicious pricing to consumer protection authorities</li>
            </ul>
          </div>
          <div class="sector-card">
            ...
            <h5>What you can do</h5>
            <ul>
              <li>Require supplier disclosure of vessel registration and flag state</li>
              <li>Include catch-documentation clauses in procurement contracts</li>
              <li>Audit tier-two suppliers, not just direct vendors</li>
            </ul>
          </div>
          <div class="sector-card">
            ...
            <h5>What you can do</h5>
            <ul>
              <li>Refuse product that cannot be traced to a named vessel and port of landing</li>
              <li>Implement electronic lot-tracking from intake to dispatch</li>
              <li>Participate in industry traceability schemes and data sharing</li>
            </ul>
          </div>
          <div class="sector-card">
            ...
            <h5>What you can do</h5>
            <ul>
              <li>Mandate import documentation including vessel ID and catch certificates</li>
              <li>Implement port-state inspection regimes aligned with the PSMA</li>
              <li>Share catch-certificate data with trading partners in real time</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="related-section reveal">
        ...
        <div class="related-grid">
          ...
          <a href="misrepresentation.php" class="related-card">
            ...
            <p>IUU product typically requires false origin claims to enter legitimate markets.</p>
          </a>
      ...
      <div class="cat-nav reveal">
        <div style="background:var(--bg-soft);border:1px solid var(--line);border-radius:6px;padding:24px;opacity:.5;">
          <div class="cat-nav-label">← Previous</div>
          <div class="cat-nav-title" style="color:var(--ink-3);font-size:16px;">This is the first category</div>
        </div>
