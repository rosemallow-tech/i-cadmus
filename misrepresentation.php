  ...
  <div class="container">
    <div class="page-hero-inner">
      <div class="breadcrumb">
        ...
        <span style="color:#fff;">Misrepresentation — False Origin & Method</span>
      </div>
      <div class="page-hero-grid">
        <div>
          <div class="cat-badge">Category 05 of 07 — I-CADMUS Framework</div>
          <h1><strong>Misrepresentation</strong> — False Origin & Method</h1>
          <p class="lede">"Wild-caught" that wasn't. "Local" that flew across an ocean. "Sustainable" with no certifier behind it.</p>
          <div style="display:flex;gap:12px;flex-wrap:wrap;">
            <a href="unreported.php" class="btn btn-primary">Next: Unreported <span class="arrow">→</span></a>
            <a href="framework.php" class="btn btn-outline" style="color:#fff;border-color:rgba(255,255,255,.4);">All seven categories</a>
          </div>
        </div>
        <div class="hero-letter-box">M</div>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="cat-page-layout">
    <aside class="framework-side">
      ...
      <ul>
        ...
        <li><a href="misrepresentation.php" class="active"><span class="letter">M</span> Misrepresentation</a></li>
    ...
    <main class="cat-content">
      <div class="cat-content-head reveal">
        <div class="cat-num">Category 05 · I-CADMUS Framework</div>
        <h2 class="cat-title">Misrepresentation — False Origin & Method</h2>
        <p class="cat-tagline">"Wild-caught" that wasn't. "Local" that flew across an ocean. "Sustainable" with no certifier behind it.</p>
      </div>

      <div class="cat-body reveal">
        <div>
          <p>Misrepresentation falsifies country-of-origin, harvest method, or sustainability claims while leaving the species itself accurate. This is the fraud behind "Australian prawns" that were processed in Australia but caught elsewhere, "wild-caught" salmon that was farmed, and "sustainable" claims unsupported by any actual certification or assessment.</p>
          <p>Misrepresentation is uniquely damaging because it targets the ethical and environmental preferences that consumers have learned to act on. <strong>When a consumer pays more for wild-caught or local product, they are making a genuine values-based decision</strong> — one that misrepresentation monetises without delivering the underlying reality. It corrupts the premium market that honest producers depend on.</p>

          <div class="why-box">
            <h4>Why it persists</h4>
            <p>Origin labelling rules vary significantly across jurisdictions. "Processed in" loopholes let importers technically meet the letter of the law while violating its intent — a product can be legally labelled "Product of Australia" if it underwent substantial processing here, even if it was caught in another country's waters. Sustainability claims have no mandatory standard behind them in most markets.</p>
          </div>
        </div>
        <div>
          <div class="cat-info-card">
            <h4>Red flags</h4>
            <ul>
              <li>Pricing inconsistent with the claimed origin's known cost base</li>
              <li>"Country of origin" missing while "processed in" appears prominently</li>
              <li>Sustainability claims without a named certifying body on the label</li>
              <li>Method claims (wild/farmed) that don't match the species' seasonal availability</li>
              <li>Species available year-round that are only genuinely available seasonally in the claimed region</li>
            </ul>
          </div>
          <div class="cat-info-card counter" style="margin-top:16px;">
            <h4>Counter-measures</h4>
            <ul>
              <li>Country-of-catch (not just country-of-processing) mandatory labelling</li>
              <li>Mandatory harvest method declaration (wild-caught / farmed) on all retail labels</li>
              <li>Certifier-name requirement on any sustainability claim</li>
              <li>Isotope and DNA traceability testing for high-value origin claims</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="sector-section reveal">
        ...
        <p class="sub">Misrepresentation is a legal and ethical issue — it requires both regulatory reform and supply chain discipline.</p>
        <div class="sector-grid">
          <div class="sector-card">
            <div class="sector-label">Consumers</div>
            <h5>What you can do</h5>
            <ul>
              <li>Look for country-of-catch, not just country-of-processing or origin</li>
              <li>Ask staff to identify the certifying body behind any sustainability claim</li>
              <li>Be sceptical of "wild-caught" on frozen product available at atypically low prices</li>
            </ul>
          </div>
          <div class="sector-card">
            ...
            <h5>What you can do</h5>
            <ul>
              <li>Require country-of-catch documentation from suppliers, not just country-of-processing</li>
              <li>Verify sustainability certifications directly with the certifying body before listing</li>
              <li>Audit menu descriptions — "local" and "wild" claims need evidentiary backing</li>
            </ul>
          </div>
          <div class="sector-card">
            ...
            <h5>What you can do</h5>
            <ul>
              <li>Record and preserve country-of-catch at intake — do not let it be overwritten by processing location</li>
              <li>Implement harvest-method declaration in all commercial documents</li>
              <li>Refuse to accept product described as "wild-caught" without catch documentation</li>
            </ul>
          </div>
          <div class="sector-card">
            ...
            <h5>What you can do</h5>
            <ul>
              <li>Close the "processed in" loophole — mandate country-of-catch on all retail labels</li>
              <li>Require certifier identification on any sustainability claim, not just certification mark</li>
              <li>Harmonise method-of-production labelling requirements with trading partners</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="related-section reveal">
        ...
        <div class="related-grid">
          ...
          <a href="substitution.php" class="related-card">
            ...
            <p>Substituted species are almost always accompanied by false method and origin claims to support the price point.</p>
          </a>
        </div>
      </div>
        ...
        <div class="related-grid" style="grid-template-columns:1fr;">
          <a href="hs-code-register.php" class="related-card" style="display:flex;align-items:center;gap:24px;">
            ...
            <div>
              ...
              <p>Explore how trade classifications create blind spots for misrepresentation — and what modernisation could look like.</p>
            </div>
          </a>
        </div>
      </div>
