...
<title>For Processors & Distributors | I-CADMUS — Supply-Chain Integrity</title>
<meta name="description" content="I-CADMUS for processors and distributors — supply-chain mapping, DNA verification workflows, risk classification, and the Industry certification tier." />
...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0;}html{scroll-behavior:smooth;}body{font-family:var(--sans);color:var(--ink);background:var(--bg);font-size:16px;line-height:1.55;-webkit-font-smoothing:antialiased;}a{color:inherit;text-decoration:none;}img{display:block;max-width:100%;}
  ...
  .page-hero{background:linear-gradient(135deg,#001e35 0%,var(--brand-dark) 45%,var(--brand) 100%);color:#fff;position:relative;overflow:hidden;padding:88px 0 110px;}
  .page-hero::before{content:'';position:absolute;inset:0;background:radial-gradient(circle at 80% 20%,rgba(184,135,11,.2),transparent 50%),radial-gradient(circle at 15% 80%,rgba(0,131,143,.2),transparent 55%);pointer-events:none;}
  ...
  .sector-eyebrow{display:inline-flex;align-items:center;gap:10px;font-size:13px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:rgba(255,255,255,.9);background:rgba(184,135,11,.2);border:1px solid rgba(184,135,11,.4);border-radius:100px;padding:6px 16px;margin-bottom:24px;}
  .sector-eyebrow::before{content:'';width:7px;height:7px;background:var(--gold);border-radius:50%;box-shadow:0 0 0 3px rgba(184,135,11,.3);}
  ...
  .hero-panel-tag{display:inline-block;background:var(--gold);color:#fff;font-size:11px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;padding:5px 12px;border-radius:2px;margin-bottom:18px;}
  ...
  .sector-nav a.active{color:var(--brand);border-bottom-color:var(--gold);font-weight:600;}
  ...
  .sector-nav a.active .s-icon{background:var(--gold);color:#fff;}
  ...
  .benefit-card::before{content:'';position:absolute;top:0;left:0;right:0;height:3px;background:var(--gold);}
  ...
  .cat-quick .cat-q-tip{font-size:12px;color:var(--gold);font-weight:600;display:flex;align-items:center;gap:6px;}
  .cat-quick .cat-q-tip::before{content:'';width:16px;height:1px;background:var(--gold);}
  .pathway-section{background:#fff;}
  .pathway-box{background:linear-gradient(135deg,#001e35,var(--brand-dark));color:#fff;border-radius:8px;padding:56px;display:grid;grid-template-columns:1.2fr 1fr;gap:56px;align-items:center;position:relative;overflow:hidden;}
  .pathway-box::after{content:'';position:absolute;right:-60px;bottom:-60px;width:300px;height:300px;background:radial-gradient(circle,rgba(184,135,11,.3),transparent 70%);pointer-events:none;}
  .pathway-tag{display:inline-block;background:var(--gold);color:#fff;font-size:11px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;padding:5px 12px;border-radius:2px;margin-bottom:20px;}
  ...
  .pathway-includes li::before{content:'✓';width:22px;height:22px;background:rgba(184,135,11,.25);border:1px solid rgba(184,135,11,.4);border-radius:50%;display:grid;place-items:center;font-size:12px;color:#ffd25e;flex-shrink:0;}
  ...
  .resource-tag{font-size:11px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:var(--gold);margin-bottom:8px;display:block;}
  ...
  .cta-band::before{content:'';position:absolute;top:0;right:0;width:50%;height:100%;background:radial-gradient(circle at 80% 50%,rgba(184,135,11,.25),transparent 70%);}
  ...
  <div class="container">
    <div class="page-hero-inner">
      <div class="breadcrumb">
        ...
        <span style="color:#fff;">Processors & Distributors</span>
      </div>
      <div class="page-hero-grid">
        <div>
          <div class="sector-eyebrow">Sector 03 — Processors & Distributors</div>
          <h1>Integrity built into <strong>every lot number.</strong></h1>
          <p class="lede">Processors and distributors are the gatekeepers of the supply chain. I-CADMUS gives you the supply-chain mapping, DNA verification workflows, and risk classification tools to keep fraudulent product out — and prove it when it counts.</p>
          <div class="hero-actions">
            <a href="contact.php" class="btn btn-primary">Talk to our team <span class="arrow">→</span></a>
            <a href="certification.php" class="btn btn-outline">View industry tier</a>
          </div>
          <div class="hero-stats">
            <div class="hero-stat"><div class="num">$1,490</div><div class="lbl">Per year · org-wide</div></div>
            <div class="hero-stat"><div class="num">Unlimited</div><div class="lbl">Staff seats</div></div>
            <div class="hero-stat"><div class="num">AS 5300</div><div class="lbl">Codex-aligned standard</div></div>
          </div>
        </div>
        <div class="hero-panel">
          <div class="hero-panel-tag">Industry Pathway</div>
          <h3>Supply-chain risk management for processors & distributors</h3>
          <p>Full-organisation coverage with DNA workflow guidance, supply-chain risk templates, and direct technical support.</p>
          <ul class="hero-panel-items">
            <li>Unlimited staff seats — org-wide</li>
            <li>Supply-chain risk classification templates</li>
            <li>DNA verification workflow guidance</li>
            <li>Industry-grade audit certification</li>
            <li>Direct technical support access</li>
            <li>AS 5300 and Codex alignment support</li>
          </ul>
          <a href="contact.php" class="btn btn-primary" style="width:100%;justify-content:center;">Talk to our team <span class="arrow">→</span></a>
        </div>
      </div>
    </div>
  </div>
...
<nav class="sector-nav">
  <div class="container">
    ...
    <a href="processors.php" class="active"><span class="s-icon">03</span> Processors & Distributors</a>
...
<section style="background:#fff;">
  <div class="container">
    ...
    <h2 class="section-h">You are the <strong>critical control point</strong> for the entire chain.</h2>
    <p class="section-sub">Every lot that leaves your facility carries your documentation. If fraudulent product enters at intake or is introduced during processing, your records are the only mechanism for tracing and containing it. HACCP keeps product safe once you trust what you've got — I-CADMUS asks the prior question.</p>
    <div class="benefits-grid reveal">
      <div class="benefit-card">
        <div class="benefit-num">01</div>
        <h4>Map and classify supply-chain risk</h4>
        <p>I-CADMUS risk templates help you classify every supplier and every product line by fraud-type vulnerability. Know where your exposure is before an audit or an enforcement visit reveals it.</p>
      </div>
      <div class="benefit-card">
        <div class="benefit-num">02</div>
        <h4>Structure your DNA verification workflow</h4>
        <p>The Industry tier includes step-by-step DNA verification workflow guidance — from when to test, which methods to use, how to document results, and what to do when a result contradicts the declared species.</p>
      </div>
      <div class="benefit-card">
        <div class="benefit-num">03</div>
        <h4>Certify your operation to industry grade</h4>
        <p>The I-CADMUS Industry certification is the standard that retailers and regulators recognise. Achieve it once — and reference it in every supplier questionnaire, tender, and audit response.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="cats-section">
  <div class="container">
    <div class="section-eyebrow">Your intake & processing guide</div>
    <h2 class="section-h">The <strong>seven categories</strong> — your supply-chain controls</h2>
    <p class="section-sub">Every I-CADMUS category maps to specific intake and processing controls. Apply these across your supplier qualification, intake inspection, and lot documentation processes.</p>
    <div class="cats-grid reveal">
      ...
      <div class="cat-quick"><a href="misrepresentation.php">
        ...
        <h5>False Origin</h5>
        <p>Record and preserve country-of-catch at intake — do not allow it to be overwritten by processing location. Implement harvest-method declaration in all commercial documents.</p>
        <div class="cat-q-tip">Full guidance</div>
      </a></div>
      ...
      <div class="cat-quick"><a href="substitution.php">
        ...
        <h5>Species Swap</h5>
        <p>Implement lot-level species identity records from intake through to dispatch. Require DNA test certificates for high-value species from international suppliers.</p>
        <div class="cat-q-tip">Full guidance</div>
      </a></div>
      <div class="cat-quick" style="background:var(--brand-dark);border-color:var(--brand-dark);display:flex;flex-direction:column;justify-content:center;">
        <div style="font-family:var(--serif);font-size:32px;font-weight:600;color:#ffd25e;margin-bottom:12px;">All 7</div>
        <p style="font-size:14px;color:rgba(255,255,255,.85);margin-bottom:16px;">Download the full industry-grade supply-chain risk template covering all seven categories.</p>
        <a href="resources.php" class="btn btn-outline" style="color:#fff;border-color:rgba(255,255,255,.4);font-size:13px;padding:9px 16px;">Get template <span class="arrow">→</span></a>
      </div>
    </div>
  </div>
</section>
...
<section class="pathway-section">
  <div class="container">
    ...
    <h2 class="section-h">The Industry tier — <strong>org-wide coverage.</strong></h2>
    <p class="section-sub">One annual licence covers your entire organisation — unlimited staff, full technical support, and the industry-grade certification that procurement teams and regulators recognise.</p>
    <div class="pathway-box reveal">
      <div>
        <div class="pathway-tag">Pathway 03 — Processors & Distributors</div>
        <div class="price-badge"><div class="price">$1,490</div><div class="cycle">Per year · org-wide · unlimited staff seats</div></div>
        <h3>Supply-chain mapping, DNA verification workflows, and risk classification <strong>fully aligned with AS 5300 and Codex.</strong></h3>
        <p>The Industry tier is designed to integrate with your existing quality-management systems. All documentation outputs are compatible with HACCP records and AS 5300 requirements.</p>
        <div style="display:flex;gap:12px;flex-wrap:wrap;">
          <a href="contact.php" class="btn btn-white">Talk to our team <span class="arrow">→</span></a>
          <a href="certification.php" class="btn btn-outline" style="color:#fff;border-color:rgba(255,255,255,.4);">View full details</a>
        </div>
      </div>
      <div>
...
<section class="resources-section">
  <div class="container">
    ...
    <h2 class="section-h">Tools built for <strong>supply-chain management.</strong></h2>
    <p class="section-sub">From risk templates to DNA workflow guides — every resource is designed for operational use in processing and distribution environments.</p>
    <div class="resources-grid reveal">
      <div class="resource-card">
        <div class="resource-icon">⌗</div>
        <span class="resource-tag">Industry · Template</span>
        <h4>Supply-Chain Risk Template</h4>
        <p>A structured risk-classification template covering all seven I-CADMUS categories. Rate each supplier and product line by fraud-type vulnerability and document mitigating controls.</p>
        <div class="resource-meta"><small>12 pages · DOCX</small><a href="resources.php">Download <span>↓</span></a></div>
      </div>
      <div class="resource-card">
        <div class="resource-icon">🔬</div>
        <span class="resource-tag">Industry · PDF</span>
        <h4>DNA Verification Workflow Guide</h4>
        <p>Step-by-step guidance on when to test, which methods to deploy, how to document results, and what to do when a result contradicts the declared species identity.</p>
        <div class="resource-meta"><small>18 pages · 1.6 MB</small><a href="resources.php">Download <span>↓</span></a></div>
      </div>
      <div class="resource-card">
        <div class="resource-icon">A</div>
        <span class="resource-tag">Reference · PDF</span>
        <h4>Glossary of Terms</h4>
        <p>The complete A-Z reference for I-CADMUS terminology, aligned with AS 5300 and Codex definitions. Essential for commercial documentation and supplier correspondence.</p>
...
<section class="cta-band">
  <div class="container">
    <div class="cta-band-grid">
      <div>
        <h2>Ready to get your <strong>operation certified</strong>?</h2>
        <p>Talk to our team about the Industry tier — supply-chain risk templates, DNA workflow guidance, and org-wide certification in one annual licence.</p>
      </div>
      <div class="cta-band-actions">
        <a href="contact.php" class="btn btn-primary">Talk to our team <span class="arrow">→</span></a>
        <a href="certification.php" class="btn btn-outline">View full pricing</a>
      </div>
    </div>
  </div>
</section>
